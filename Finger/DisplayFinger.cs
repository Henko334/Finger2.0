...
namespace Finger
{    
    public class DisplayFinger
    {
        #region ---Variables---
        public int mfpWidth;
        public int mfpHeight;
        public byte[] FPBuffer;
        #endregion

        public DisplayFinger(int mfpWidth, int mfpHeight, byte[] fPBuffer)
        {
            this.mfpWidth = mfpWidth;
            this.mfpHeight = mfpHeight;
            FPBuffer = fPBuffer;
        }

        public Bitmap DisplayFingerPrintImage()
        {
